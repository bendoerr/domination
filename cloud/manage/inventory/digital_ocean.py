...
or environment variables (DO_API_TOKEN)\n''')
    ...
    def read_settings(self):
        ...
        # DNS Name
        if config.has_option('digital_ocean', 'use_name'):
            self.use_name = config.getboolean('digital_ocean', 'use_name')

        if config.has_option('digital_ocean', 'use_name_domain'):
            self.use_name_domain = config.get('digital_ocean', 'use_name_domain')
    ...
    def build_inventory(self):
        ...
        for droplet in self.data['droplets']:
            ...
            if self.use_name:
                dest = droplet['name'] + self.use_name_domain
